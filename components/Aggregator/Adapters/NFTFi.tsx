	...
	return (
		<div>
			<div className="relative flex items-center justify-center gap-2 border border-b-0 border-[#252525] py-2 px-4">
				...
				<h1 className="font-light">NFTfi</h1>
...
const Pool = ({ pool }: { pool: INFTFiQuote }) => {
	...
	return (
		<tr>
			...
			<td className="h-[2.625rem] border border-[#252525] p-2 text-center text-sm font-light">{pool.interest} APR</td>
			<td className="h-[2.625rem] border border-[#252525] p-2 text-center text-sm font-light">
				{data &&
