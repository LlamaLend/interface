		...
		<div>
			<div className="relative flex min-h-[2.625rem] items-center justify-center gap-2 rounded-t-xl border border-b-0 border-[#252525] bg-[#111111] p-2">
				...
				<a
					...
					className="absolute right-0 top-1 bottom-1 my-auto mx-6 flex flex-nowrap items-center justify-center gap-1 rounded-xl bg-[#243b55] p-2 text-xs"
				>
				...
				<table className="w-full min-w-[43.75rem] table-fixed border-collapse rounded-xl bg-[#010101]">
					<thead className="h-[2.625rem] bg-[#111111]">
						<tr>
							...
							<th className="border border-[#252525] p-2 text-sm font-normal text-[#989898]">Credit</th>
							<th className="border border-[#252525] p-2 text-sm font-normal text-[#989898]">Liquidation Limit</th>
						</tr>
					</thead>
					<tbody>
