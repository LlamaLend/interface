...
export function useAddLiquidator({ userAddress, chainId, poolAddress, liquidatorAddress }: ILiquidator) {
	...
	const { config: contractConfig } = usePrepareContractWrite({
		...
		enabled: chain?.id === chainId && address?.toLowerCase() === userAddress?.toLowerCase() && validAddress
	})
...
export function useRemoveLiquidator({ liquidatorAddress, userAddress, chainId, poolAddress }: ILiquidator) {
	const txContext = useTxContext()
